...
<html lang="fr">
  <head>
	...
	<title>Annuaire_nws/Modification</title>
            ...
            <div class="col-md-12">
                    ...
                    if(isset($_GET['an_id']))
                        {
                            ...
                            $query = "SELECT * FROM annuaire WHERE an_id=:modif_id LIMIT 1";
                ...
                ?>
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="modif_contact" class="btn btn-primary">Modifier</button>
                            </div>
